...
// Check if a candle's timestamp aligns with a 4H boundary (IST timezone)
// 4H blocks start at: 00:00, 04:00, 08:00, 12:00, 16:00, 20:00 IST
function is4HStartingCandle(tsMs) {
  const date = new Date(tsMs + IST_OFFSET_MS);
